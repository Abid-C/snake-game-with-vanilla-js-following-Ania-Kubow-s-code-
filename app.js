document.addEventListener('DOMContentLoaded', () => {
    ...
    function moveOutcomes() {
        ...
        //deals with snake hitting the border and with itself
        if (
        ...
        //deals with snake hitting the apple
    ...
    //generate new apple once the snake eats is
    ...
    function control(e) {
        ...
        if(e.keyCode === 39) {
            ...
            direction = +width //if we press down arrow, the snake will go ahead 10 divs from where the head is, appearing to go down
        }
